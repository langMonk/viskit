...
visualize(invoke_fit_transform(IVHD.IVHD(types.OptimizerType.Momentum)), "IVHD_MOMENTUM")
visualize(invoke_fit_transform(IVHD.IVHD(types.OptimizerType.ForceDirected)), "IVHD_FORCEDIRECTED")
visualize(invoke_fit_transform(IVHD.IVHD(types.OptimizerType.Adadelta)), "IVHD_Adadelta")
visualize(invoke_fit_transform(IVHD.IVHD(types.OptimizerType.Adam)), "IVHD_Adam")
visualize(invoke_fit_transform(IVHD.IVHD(types.OptimizerType.Nesterov)), "IVHD_Nesterov")
visualize(invoke_fit_transform(IVHD.IVHD(types.OptimizerType.tSNE)), "IVHD_tSNE")
visualize(invoke_fit_transform(LargeVis.LargeVis(types.OptimizerType.NONE)), "Largevis_None")
print("done")
