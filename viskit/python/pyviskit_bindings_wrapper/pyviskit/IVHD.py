...
class IVHD(AbstractCaster):
    def __init__(self,
        ...
        if optimizer_type == bindings.OptimizerType.NONE or optimizer_type == bindings.OptimizerType.SGD:
            optimizer_type = bindings.OptimizerType.ForceDirected
        super().__init__(bindings.CasterType.IVHD, optimizer_type, parser_type, graph_generator_type, **kwargs)
